...
//        */
//       public abstract void onStateChanged(@NonNull View bottomSheet, @BottomSheetAnchorBehavior.State int newState);
//
//       /**
...
//
//     private static final String TAG = "BottomSheetAnchorBehavior";
//
//     @BottomSheetAnchorBehavior.SaveFlags
...
//
//     @NonNull private final ArrayList<BottomSheetAnchorBehavior.BottomSheetCallback> callbacks = new ArrayList<>();
//
...
//
//     public BottomSheetAnchorBehavior(@NonNull Context context, @Nullable AttributeSet attrs) {
//       super(context, attrs);
...
//       return new BottomSheetAnchorBehavior(super.onSaveInstanceState(parent, child), this);
//     }
//
//     @Override
//     public void onRestoreInstanceState(
//       @NonNull CoordinatorLayout parent, @NonNull V child, @NonNull Parcelable state) {
//       BottomSheetAnchorBehavior ss = (BottomSheetAnchorBehavior) state;
...
//      */
//     public void setSaveFlags(@BottomSheetAnchorBehavior.SaveFlags int flags) {
...
//      * @deprecated use {@link #addBottomSheetCallback(BottomSheetAnchorBehavior.BottomSheetCallback)} and {@link
//      *     #removeBottomSheetCallback(BottomSheetAnchorBehavior.BottomSheetCallback)} instead
//      */
//     @Deprecated
//     public void setBottomSheetCallback(BottomSheetAnchorBehavior.BottomSheetCallback callback) {
//       Log.w(
//         TAG,
//         "BottomSheetAnchorBehavior now supports multiple callbacks. `setBottomSheetCallback()` removes"
...
//      * @param callback The callback to notify when bottom sheet events occur.
//      */
//     public void addBottomSheetCallback(@NonNull BottomSheetAnchorBehavior.BottomSheetCallback callback) {
...
//      */
//     public void removeBottomSheetCallback(@NonNull BottomSheetAnchorBehavior.BottomSheetCallback callback) {
...
//     }
//
//     private void settleToStatePendingLayout(@BottomSheetAnchorBehavior.State int state) {
...
//      */
//     @BottomSheetAnchorBehavior.State
//     public int getState() {
//       return state;
//     }
//
//     void setStateInternal(@BottomSheetAnchorBehavior.State int state) {
//       if (this.state == state) {
//         return;
//       }
//       this.state = state;
...
//     }
//
//     private void updateDrawableForTargetState(@BottomSheetAnchorBehavior.State int state) {
//       if (state == STATE_SETTLING) {
...
//     }
//
//     private void restoreOptionalState(@NonNull BottomSheetAnchorBehavior ss) {
...
//           settleRunnable = new com.google.android.material.bottomsheet.BottomSheetAnchorBehavior.SettleRunnable(child, state);
//         }
...
//           int top;
//           @BottomSheetAnchorBehavior.State int targetState;
//           if (yvel < 0) { // Moving up
//             if (fitToContents) {
//               top = fitToContentsOffset;
//               targetState = STATE_EXPANDED;
...
//       int targetState;
//
//       SettleRunnable(View view, @BottomSheetAnchorBehavior.State int targetState) {
//         this.view = view;
...
//       }
//
//       public SavedState(Parcelable superState, @NonNull com.google.android.material.bottomsheet.BottomSheetAnchorBehavior<?> behavior) {
//         super(superState);
...
//
//       /**
//        * This constructor does not respect flags: {@link com.google.android.material.bottomsheet.BottomSheetAnchorBehavior#SAVE_PEEK_HEIGHT}, {@link
//        * com.google.android.material.bottomsheet.BottomSheetAnchorBehavior#SAVE_FIT_TO_CONTENTS}, {@link com.google.android.material.bottomsheet.BottomSheetAnchorBehavior#SAVE_HIDEABLE}, {@link
//        * com.google.android.material.bottomsheet.BottomSheetAnchorBehavior#SAVE_SKIP_COLLAPSED}. It is as if {@link com.google.android.material.bottomsheet.BottomSheetAnchorBehavior#SAVE_NONE}
//        * were set.
//        *
//        * @deprecated Use {@link BottomSheetAnchorBehavior (Parcelable, com.google.android.material.bottomsheet.BottomSheetAnchorBehavior )} instead.
//        */
//       @Deprecated
...
//       }
//
//       public static final Creator<BottomSheetAnchorBehavior> CREATOR =
//         new ClassLoaderCreator<BottomSheetAnchorBehavior>() {
//           @NonNull
//           @Override
//           public BottomSheetAnchorBehavior createFromParcel(@NonNull Parcel in, ClassLoader loader) {
//             return new BottomSheetAnchorBehavior(in, loader);
//           }
//
//           @Nullable
//           @Override
//           public BottomSheetAnchorBehavior createFromParcel(@NonNull Parcel in) {
//             return new BottomSheetAnchorBehavior(in, null);
//           }
//
//           @NonNull
//           @Override
//           public BottomSheetAnchorBehavior[] newArray(int size) {
//             return new BottomSheetAnchorBehavior[size];
//           }
//         };
//     }
//
//     /**
//      * A utility function to get the {@link com.google.android.material.bottomsheet.BottomSheetAnchorBehavior} associated with the {@code view}.
//      *
//      * @param view The {@link View} with {@link com.google.android.material.bottomsheet.BottomSheetAnchorBehavior}.
//      * @return The {@link com.google.android.material.bottomsheet.BottomSheetAnchorBehavior} associated with the {@code view}.
//      */
//     @NonNull
//     @SuppressWarnings("unchecked")
//     public static <V extends View> com.google.android.material.bottomsheet.BottomSheetAnchorBehavior<V> from(@NonNull V view) {
...
//       if (!(behavior instanceof com.google.android.material.bottomsheet.BottomSheetAnchorBehavior)) {
//         throw new IllegalArgumentException("The view is not associated with BottomSheetAnchorBehavior");
//       }
//       return (com.google.android.material.bottomsheet.BottomSheetAnchorBehavior<V>) behavior;
//     }
//
//     /**
